...
export const conversations: Conversation[] = [
  // DM: CEO <-> Aria
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-alex', content: 'Aria, can you review the auth module PR?', timestamp: '2026-06-14T09:00:00Z' },
      { id: 'm2', senderId: 'emp-aria', content: 'On it. I see 3 potential issues in the token validation logic.', timestamp: '2026-06-14T09:01:00Z', isStreaming: false },
      { id: 'm3', senderId: 'emp-aria', content: 'First, the JWT expiry check is missing a grace period for clock skew. Second, the refresh token rotation isn\'t atomic — race condition possible. Third, rate limiting on login needs to be per-IP, not just per-user.', timestamp: '2026-06-14T09:02:30Z' },
      { id: 'm4', senderId: 'emp-alex', content: 'Great catches. Can you open tickets for each?', timestamp: '2026-06-14T09:05:00Z' },
      { id: 'm5', senderId: 'emp-aria', content: 'Done. TAX-151, TAX-152, TAX-153 created and assigned.', timestamp: '2026-06-14T09:06:00Z' },
      { id: 'm6', senderId: 'emp-alex', content: 'How\'s the IRS API integration going?', timestamp: '2026-06-15T10:00:00Z' },
      { id: 'm7', senderId: 'emp-aria', content: '87% complete. The staging environment is fully connected. I\'m working through edge cases for rejected filings. About 12 more scenarios to handle.', timestamp: '2026-06-15T10:01:00Z' },
      { id: 'm8', senderId: 'emp-alex', content: 'Timeline looking good for May 15?', timestamp: '2026-06-15T10:03:00Z' },
      { id: 'm9', senderId: 'emp-aria', content: 'Yes, on track. I\'ll have the integration tests green by May 10.', timestamp: '2026-06-15T10:04:00Z' },
      { id: 'm10', senderId: 'emp-alex', content: 'Perfect. Keep me posted.', timestamp: '2026-06-15T10:05:00Z' },
    ],
  ...
  // DM: Maya <-> Manager
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-manager', content: 'Good morning Maya. Here\'s your daily standup summary:\n\n**Sprint 12 — Tax Filing**\n- 5 tickets in progress, 3 in review\n- Velocity trending at 42 SP (target: 45)\n- Risk: IRS API integration has 2 open blockers\n\n**Sprint 8 — Mobile App**\n- Behind by 3 SP due to a11y fixes\n- Pixel needs design review approval\n\n**Upcoming:**\n- Sprint planning tomorrow 10:00 AM', timestamp: '2026-06-15T08:00:00Z' },
      { id: 'm2', senderId: 'emp-maya', content: 'Thanks. Can you schedule a deep-dive on the IRS API blockers?', timestamp: '2026-06-15T08:15:00Z' },
      { id: 'm3', senderId: 'emp-manager', content: 'Scheduled for today at 2:00 PM. Attendees: Aria, Sage, Echo. Agenda:\n1. IRS API error handling review\n2. Staging environment status\n3. Rollback plan for production', timestamp: '2026-06-15T08:16:00Z' },
      { id: 'm4', senderId: 'emp-maya', content: 'Add Raj to that — he\'s been working on the error UI.', timestamp: '2026-06-15T08:20:00Z' },
      { id: 'm5', senderId: 'emp-manager', content: 'Done. Invite sent to Raj.', timestamp: '2026-06-15T08:21:00Z' },
      { id: 'm6', senderId: 'emp-manager', content: 'Weekly report ready. Summary: All 3 projects active. 2 risks flagged this week. Velocity up 12% vs last sprint. Budget on track at 68% spent with 60% timeline elapsed.', timestamp: '2026-06-14T17:00:00Z' },
      { id: 'm7', senderId: 'emp-maya', content: 'Can you highlight the top risk for the leadership sync?', timestamp: '2026-06-14T17:05:00Z' },
      { id: 'm8', senderId: 'emp-manager', content: 'Top risk: Mobile App redesign is behind by 12% due to design system migration complexity. Pixel flagged 12 accessibility issues. Recommend allocating an additional frontend dev for 2 sprints.', timestamp: '2026-06-14T17:06:00Z' },
      { id: 'm9', senderId: 'emp-maya', content: 'I\'ll discuss with Alex Chen. Good work.', timestamp: '2026-06-14T17:10:00Z' },
      { id: 'm10', senderId: 'emp-manager', content: 'Standup starting in 5 minutes. 4 team members confirmed. Raj is out today — sick leave.', timestamp: '2026-06-15T09:25:00Z' },
    ],
    lastMessageAt: '2026-06-15T09:25:00Z',
    unreadCount: 2,
  },
  // DM: Raj <-> Sage
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-raj', content: 'Hey Sage, quick question on the auth middleware. How are you handling the token refresh in the GraphQL context?', timestamp: '2026-06-14T14:00:00Z' },
      { id: 'm2', senderId: 'emp-sage', content: 'I\'m using a short-lived access token (15 min) with a sliding refresh. The context builder checks expiry on each request and silently refreshes if within 5 min of expiry.', timestamp: '2026-06-14T14:02:00Z' },
      { id: 'm3', senderId: 'emp-raj', content: 'Smart. What about concurrent requests during refresh?', timestamp: '2026-06-14T14:05:00Z' },
      { id: 'm4', senderId: 'emp-sage', content: 'Redis lock with SET NX. First request refreshes, others wait up to 3 seconds then use the new token. Want me to share the code?', timestamp: '2026-06-14T14:07:00Z' },
      { id: 'm5', senderId: 'emp-raj', content: 'Yes please! I need something similar for the mobile auth flow.', timestamp: '2026-06-14T14:08:00Z' },
      { id: 'm6', senderId: 'emp-sage', content: 'Pushed to the `auth-patterns` branch. Check `src/auth/token-refresh.ts`. Let me know if you have questions!', timestamp: '2026-06-14T14:15:00Z' },
      { id: 'm7', senderId: 'emp-raj', content: 'This is exactly what I needed. Thanks!', timestamp: '2026-06-14T14:20:00Z' },
      { id: 'm8', senderId: 'emp-sage', content: 'Also — I added a fallback to session cookies if refresh fails. Graceful degradation for offline scenarios.', timestamp: '2026-06-14T14:22:00Z' },
    ],
    lastMessageAt: '2026-06-14T14:22:00Z',
    unreadCount: 0,
  },
  // DM: Priya <-> Pixel
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-priya', content: 'Pixel, the color contrast on the new button component fails WCAG AA. The ratio is 3.8:1, needs to be 4.5:1 minimum.', timestamp: '2026-06-14T11:00:00Z' },
      { id: 'm2', senderId: 'emp-pixel', content: 'Thanks for catching that! I\'ll adjust the primary color to a darker shade. Should I also update the hover state?', timestamp: '2026-06-14T11:01:00Z' },
      { id: 'm3', senderId: 'emp-priya', content: 'Yes please. And can you add focus-visible styles for keyboard navigation? The current focus ring is too subtle.', timestamp: '2026-06-14T11:03:00Z' },
      { id: 'm4', senderId: 'emp-pixel', content: 'Updated in the design system Figma. New contrast ratio: 7.2:1. Added 2px brand-primary focus ring with 2px offset. Screenshots attached.', timestamp: '2026-06-14T11:15:00Z' },
      { id: 'm5', senderId: 'emp-priya', content: 'Looks great! I\'ll update the test cases to match.', timestamp: '2026-06-14T11:20:00Z' },
    ],
  ...
  // DM: Alex Chen <-> Maya
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-alex', content: 'Maya, how are we looking for the Q2 review?', timestamp: '2026-06-13T16:00:00Z' },
      { id: 'm2', senderId: 'emp-maya', content: 'Overall positive. Tax Platform is on track, API Modernization is green. Only concern is Mobile App — behind by 12%.', timestamp: '2026-06-13T16:05:00Z' },
      { id: 'm3', senderId: 'emp-alex', content: 'What do you need to get Mobile back on track?', timestamp: '2026-06-13T16:07:00Z' },
      { id: 'm4', senderId: 'emp-maya', content: 'I\'d like to pull Aria onto the Mobile sprint for 1 week. Her full-stack skills would unblock the frontend team.', timestamp: '2026-06-13T16:10:00Z' },
      { id: 'm5', senderId: 'emp-alex', content: 'Approved. Make the call.', timestamp: '2026-06-13T16:12:00Z' },
      { id: 'm6', senderId: 'emp-maya', content: 'Will do. I\'ll also schedule a design review with Pixel for the navigation component. We need to nail the UX before Raj implements.', timestamp: '2026-06-13T16:15:00Z' },
      { id: 'm7', senderId: 'emp-alex', content: 'Good thinking. Keep me posted on the IRS integration timeline.', timestamp: '2026-06-13T16:18:00Z' },
      { id: 'm8', senderId: 'emp-maya', content: 'Aria says May 10 for test completion. Production ready by May 15.', timestamp: '2026-06-13T16:20:00Z' },
      { id: 'm9', senderId: 'emp-alex', content: 'That works. Tax season is winding down — we have a comfortable window.', timestamp: '2026-06-13T16:22:00Z' },
    ],
    lastMessageAt: '2026-06-13T16:22:00Z',
    unreadCount: 0,
  },
  ...
  // Group DM: Project TAX
  {
    ...
    messages: [
      { id: 'm1', senderId: 'emp-manager', content: 'Project TAX — Sprint 12 Mid-Sprint Review\n\nProgress: 62% complete (on track)\nVelocity: 42 SP committed, 28 completed, 14 remaining\n\n**At Risk:**\n- IRS API integration: 2 edge cases unresolved\n- SOC2 audit: penetration testing delayed by 3 days', timestamp: '2026-06-14T17:00:00Z' },
      { id: 'm2', senderId: 'emp-aria', content: 'Update on IRS API: I resolved the rejected filing edge cases. Down to 12 scenarios, all with clear handling paths.', timestamp: '2026-06-14T17:15:00Z' },
      { id: 'm3', senderId: 'emp-echo', content: 'Pen test rescheduled for May 2. Vendor confirmed.', timestamp: '2026-06-14T17:20:00Z' },
      { id: 'm4', senderId: 'emp-priya', content: 'Automation suite is green. I added 23 new test cases for the payment flow.', timestamp: '2026-06-14T17:25:00Z' },
      { id: 'm5', senderId: 'emp-maya', content: 'Great work team. Let\'s keep the momentum going. Standup tomorrow at 9:30.', timestamp: '2026-06-14T17:30:00Z' },
    ],
    lastMessageAt: '2026-06-14T17:30:00Z',
    unreadCount: 0,
  },
];
...
export const emailThreads: EmailThread[] = [
  {
    ...
    to: ['alex@acme-corp.com'],
    messages: [
      { id: 'em1-1', from: 'sarah.chen@clientcorp.com', content: 'Hi Alex, We\'d love to see multi-state tax filing in Q2. Our team files in CA, NY, and TX. Is this on the roadmap?', timestamp: '2026-06-13T10:00:00Z' },
      { id: 'em1-2', from: 'alex@acme-corp.com', content: 'Hi Sarah, Yes! Multi-state is planned for Q3. I\'ll have our PM send you a detailed timeline by Friday.', timestamp: '2026-06-13T14:00:00Z' },
      { id: 'em1-3', from: 'sarah.chen@clientcorp.com', content: 'That\'s great news. We\'re happy to be beta testers when ready.', timestamp: '2026-06-14T09:00:00Z' },
    ],
  ...
  },
  {
    ...
    to: ['echo@acme-corp.com', 'alex@acme-corp.com'],
    messages: [
      { id: 'em2-1', from: 'billing@aws.amazon.com', content: 'Your April 2025 AWS invoice is available. Total: $3,847.23. Due date: May 15, 2025.', timestamp: '2026-06-12T08:00:00Z' },
      { id: 'em2-2', from: 'echo@acme-corp.com', content: 'Received. Within budget. Auto-payment configured.', timestamp: '2026-06-12T09:00:00Z' },
    ],
  ...
  },
  {
    ...
    to: ['echo@acme-corp.com', 'manager@acme-corp.com'],
    messages: [
      ...
      { id: 'em3-2', from: 'manager@acme-corp.com', content: 'We\'re compiling these. Expected delivery: May 5. I\'ll coordinate with Echo on the technical documents.', timestamp: '2025-04-25T15:00:00Z' },
    ],
    lastMessageAt: '2026-06-14T15:00:00Z',
    unread: true,
  ...
  },
  {
    ...
    to: ['alex@acme-corp.com'],
    messages: [
      { id: 'em4-1', from: 'partnerships@intuit.com', content: 'Dear Alex, We\'d like to explore an integration partnership between BrixOS and QuickBooks. Could we schedule a call next week?', timestamp: '2025-04-24T11:00:00Z' },
      { id: 'em4-2', from: 'alex@acme-corp.com', content: 'I\'m interested. How about Tuesday at 2 PM PT? I\'ll loop in our integrations lead.', timestamp: '2025-04-24T16:00:00Z' },
  ...
  },
  {
    ...
    from: 'recruiting@acme-corp.com',
    to: ['maya@acme-corp.com'],
    messages: [
      { id: 'em5-1', from: 'recruiting@acme-corp.com', content: 'Hi Maya, We have a promising candidate for the Senior Frontend role: Alex Kim (ex-Stripe, 6 years React). Portfolio looks strong. Shall we schedule a technical screen?', timestamp: '2026-06-15T09:00:00Z' },
      { id: 'em5-2', from: 'maya@acme-corp.com', content: 'Yes, please schedule. I want Raj on the panel too — he knows what we need.', timestamp: '2026-06-15T10:00:00Z' },
    ],
...
export const meetings: Meeting[] = [
  {
    id: 'mtg-1', title: 'Engineering Daily Standup', startTime: '2026-06-15T09:30:00', endTime: '2026-06-15T09:45:00',
  ...
  {
    id: 'mtg-2', title: 'Maya <> Raj 1:1', startTime: '2026-06-15T14:00:00', endTime: '2026-06-15T14:30:00',
  ...
  {
    id: 'mtg-3', title: 'Sprint 13 Planning', startTime: '2026-06-16T10:00:00', endTime: '2026-06-16T11:30:00',
  ...
  {
    id: 'mtg-4', title: 'IRS API Deep Dive', startTime: '2026-06-15T14:00:00', endTime: '2026-06-15T15:00:00',
  ...
  {
    id: 'mtg-5', title: 'Design Review — Navigation Component', startTime: '2026-06-16T15:00:00', endTime: '2026-06-16T16:00:00',
  ...
  {
    id: 'mtg-6', title: 'Sprint 12 Retrospective', startTime: '2026-06-17T16:00:00', endTime: '2026-06-17T17:00:00',
  ...
  {
    id: 'mtg-7', title: 'Alex Chen <> Maya — Weekly Sync', startTime: '2026-06-16T10:00:00', endTime: '2026-06-16T10:30:00',
  ...
  {
    id: 'mtg-8', title: 'QuickBooks Partnership Call', startTime: '2026-06-18T14:00:00', endTime: '2026-06-18T15:00:00',
...
export const approvals: Approval[] = [
  // ── Pending (4) ──
  {
    ...
    createdAt: '2026-06-15T10:00:00Z', dueAt: '2025-05-01T10:00:00Z', sla: '24h',
  },
  {
    ...
    createdAt: '2026-06-15T08:00:00Z', dueAt: '2026-06-15T18:00:00Z', sla: '10h',
  },
  {
    ...
    requesterId: 'emp-echo', approverId: 'emp-alex', status: 'pending',
    createdAt: '2026-06-14T14:00:00Z', dueAt: '2025-05-02T14:00:00Z', sla: '72h',
  },
  {
    ...
    createdAt: '2026-06-15T09:00:00Z', dueAt: '2025-05-03T09:00:00Z', sla: '72h',
  },
  // ── Approved (12) ──
  {
    ...
    createdAt: '2026-06-13T09:00:00Z', dueAt: '2026-06-14T09:00:00Z', sla: '24h',
  },
  {
    ...
    createdAt: '2026-06-12T10:00:00Z', dueAt: '2026-06-12T18:00:00Z', sla: '8h',
  },
  {
    ...
    createdAt: '2025-04-25T11:00:00Z', dueAt: '2026-06-13T11:00:00Z', sla: '72h',
  },
  {
    ...
    createdAt: '2025-04-24T08:00:00Z', dueAt: '2026-06-11T08:00:00Z', sla: '48h',
  },
  {
...
export const activities: Activity[] = [
  { id: 'act-1', type: 'commit', actorId: 'emp-aria', targetName: 'feat/auth-oauth', message: 'Aria pushed commit `feat/auth-oauth` to Tax Filing', timestamp: '2026-06-15T10:02:00Z', projectId: 'proj-tax' },
  { id: 'act-2', type: 'pr-merged', actorId: 'emp-maya', targetName: 'PR #347', message: 'Maya approved PR #347 — IRS API integration', timestamp: '2026-06-15T09:45:00Z', projectId: 'proj-tax' },
  { id: 'act-3', type: 'file-uploaded', actorId: 'emp-pixel', targetName: 'Mobile App Figma', message: 'Pixel uploaded 3 mockups to Mobile App Redesign', timestamp: '2026-06-15T09:30:00Z', projectId: 'proj-mob' },
  { id: 'act-4', type: 'ticket-completed', actorId: 'emp-sage', targetName: 'TAX-146', message: 'Sage fixed memory leak in PDF parser (TAX-146)', timestamp: '2026-06-15T09:00:00Z', projectId: 'proj-tax' },
  { id: 'act-5', type: 'deploy-shipped', actorId: 'emp-echo', targetName: 'staging', message: 'Echo deployed API v2.2.0 to staging', timestamp: '2026-06-15T08:30:00Z', projectId: 'proj-api' },
  { id: 'act-6', type: 'mention', actorId: 'emp-raj', targetName: 'aria', message: 'Raj mentioned Aria in #frontend: "Need help with GraphQL resolver"', timestamp: '2026-06-15T08:15:00Z' },
  { id: 'act-7', type: 'status-change', actorId: 'emp-manager', targetName: 'TAX-144', message: 'Manager moved TAX-144 to In Progress', timestamp: '2026-06-15T08:00:00Z', projectId: 'proj-tax' },
  { id: 'act-8', type: 'risk-flagged', actorId: 'emp-pixel', targetName: 'MOB-90', message: 'Pixel flagged 12 accessibility issues in Mobile App', timestamp: '2026-06-14T17:00:00Z', projectId: 'proj-mob' },
  { id: 'act-9', type: 'review-submitted', actorId: 'emp-priya', targetName: 'MOB-94', message: 'Priya completed cross-browser testing review', timestamp: '2026-06-14T16:30:00Z', projectId: 'proj-mob' },
  { id: 'act-10', type: 'goal-updated', actorId: 'emp-manager', targetName: 'Q2 OKRs', message: 'Manager updated Q2 OKR progress: 73% on track', timestamp: '2026-06-14T16:00:00Z' },
  { id: 'act-11', type: 'sprint-completed', actorId: 'emp-manager', targetName: 'Sprint 11', message: 'Sprint 11 completed: 38 SP, 95% commitment met', timestamp: '2026-06-14T15:00:00Z', projectId: 'proj-tax' },
  { id: 'act-12', type: 'approval-needed', actorId: 'emp-echo', targetName: 'Deploy v2.3.1', message: 'Echo requested production deploy approval', timestamp: '2026-06-15T10:00:00Z', projectId: 'proj-tax' },
  { id: 'act-13', type: 'meeting-started', actorId: 'emp-manager', targetName: 'Daily Standup', message: 'Manager started Engineering standup', timestamp: '2026-06-15T09:30:00Z' },
  { id: 'act-14', type: 'commit', actorId: 'emp-sage', targetName: 'fix/pdf-memory-leak', message: 'Sage pushed commit `fix/pdf-memory-leak`', timestamp: '2026-06-15T08:45:00Z', projectId: 'proj-tax' },
  { id: 'act-15', type: 'comment', actorId: 'emp-aria', targetName: 'TAX-150', message: 'Aria commented on TAX-150: "Migration script ready for review"', timestamp: '2026-06-15T07:30:00Z', projectId: 'proj-tax' },
  { id: 'act-16', type: 'ticket-completed', actorId: 'emp-echo', targetName: 'API-58', message: 'Echo completed API rate limiting setup (API-58)', timestamp: '2026-06-14T18:00:00Z', projectId: 'proj-api' },
  { id: 'act-17', type: 'mention', actorId: 'emp-alex', targetName: 'maya', message: 'Alex mentioned Maya: "Q2 review looking good"', timestamp: '2026-06-14T17:30:00Z' },
  { id: 'act-18', type: 'file-uploaded', actorId: 'emp-echo', targetName: 'k6-load-tests', message: 'Echo uploaded load test results for API endpoints', timestamp: '2026-06-14T15:00:00Z', projectId: 'proj-api' },
  { id: 'act-19', type: 'status-change', actorId: 'emp-pixel', targetName: 'MOB-89', message: 'Pixel completed design tokens task (MOB-89)', timestamp: '2026-06-14T14:00:00Z', projectId: 'proj-mob' },
  { id: 'act-20', type: 'deploy-shipped', actorId: 'emp-echo', targetName: 'production', message: 'Echo hotfixed production: PDF parser patch', timestamp: '2026-06-14T12:00:00Z', projectId: 'proj-tax' },
  { id: 'act-21', type: 'commit', actorId: 'emp-raj', targetName: 'feat/nav-drawer', message: 'Raj pushed commit `feat/nav-drawer` to Mobile App', timestamp: '2026-06-14T11:00:00Z', projectId: 'proj-mob' },
  { id: 'act-22', type: 'review-submitted', actorId: 'emp-priya', targetName: 'TAX-148', message: 'Priya approved payment gateway QA (TAX-148)', timestamp: '2026-06-14T10:30:00Z', projectId: 'proj-tax' },
];
