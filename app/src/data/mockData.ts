...
export const emailThreads: EmailThread[] = [
  {
    ...
    messages: [
      ...
      { id: 'em1-2', from: 'alex@acme-corp.com', content: 'Hi Sarah, Yes! Multi-state is planned for Q3. I\'ll have our PM send you a detailed timeline by Friday.', timestamp: '2025-04-28T14:00:00Z' },
  ...
  },
  {
    ...
    messages: [
      ...
      { id: 'em2-2', from: 'echo@acme-corp.com', content: 'Received. Within budget. Auto-payment configured.', timestamp: '2025-04-27T09:00:00Z' },
    ],
  ...
  },
  {
    ...
    messages: [
      { id: 'em5-1', from: 'recruiting@acme-corp.com', content: 'Hi Maya, We have a promising candidate for the Senior Frontend role: Alex Kim (ex-Stripe, 6 years React). Portfolio looks strong. Shall we schedule a technical screen?', timestamp: '2025-04-30T09:00:00Z' },
      { id: 'em5-2', from: 'maya@acme-corp.com', content: 'Yes, please schedule. I want Raj on the panel too — he knows what we need.', timestamp: '2025-04-30T10:00:00Z' },
    ],
