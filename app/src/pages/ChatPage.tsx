...
const WORKSPACE_MEMBERS: WorkspaceMember[] = [
  ...
  { id: 'u-aria', name: 'Aria', title: 'AI Sr. Developer', email: 'aria@brixos.io', status: 'online', kind: 'ai', initials: 'AR', color: '#C4623E' },
  { id: 'u-sage', name: 'Sage', title: 'AI Backend Dev', email: 'sage@brixos.io', status: 'online', kind: 'ai', initials: 'SG', color: '#A8542F' },
  { id: 'u-pixel', name: 'Pixel', title: 'AI Designer', email: 'pixel@brixos.io', status: 'online', kind: 'ai', initials: 'PX', color: '#C4623E' },
  { id: 'u-echo', name: 'Echo', title: 'AI DevOps', email: 'echo@brixos.io', status: 'online', kind: 'ai', initials: 'EC', color: '#A8542F' },
