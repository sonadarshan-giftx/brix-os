...
const ACTIVITY_COLORS: Record<string, string> = {
  commit: '#C4623E', 'pr-merged': '#16a34a', 'deploy-shipped': '#2563eb',
...
export default function Home() {
  ...
  return (
    <div style={{
      ...
      {/* ── Hero Header ── */}
      <div style={{
        background: `linear-gradient(135deg, ${BRAND_DARK} 0%, #C4623E 50%, #B5654A 100%)`,
        padding: '28px 36px 32px',
        position: 'relative', overflow: 'hidden',
      }}>
        {/* BG glow */}
        <div style={{ position: 'absolute', top: -60, right: -60, width: 300, height: 300, borderRadius: '50%', background: 'rgba(217,119,87,0.15)', filter: 'blur(60px)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: -40, left: 200, width: 200, height: 200, borderRadius: '50%', background: 'rgba(217,119,87,0.2)', filter: 'blur(40px)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 12, marginTop: 24, position: 'relative' }}>
          {[
            ...
            { label: 'In Progress',      value: stats.inProgress,     change: `${stats.inReview} in review`, color: '#E8946F' },
                ...
                {aiEmployees.map(emp => (
                  <div key={emp.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '6px 0' }}>
                    <div style={{
                      ...
                      background: `linear-gradient(135deg, #C4623E, #D97757)`,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
