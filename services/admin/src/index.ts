...
app.get('/health', (_, res) => res.json({ service: 'brixstac-admin-service', status: 'ok', ts: new Date().toISOString() }));
app.use('/', routes);
...
app.listen(PORT, () => console.log(`[brixstac-admin-service] running on :${PORT}`));
export default app;
