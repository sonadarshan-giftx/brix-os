...
app.get('/health', (_, res) => res.json({ service: 'brixstac-billing-service', status: 'ok', ts: new Date().toISOString() }));
app.use('/', routes);
...
app.listen(PORT, () => console.log(`[brixstac-billing-service] running on :${PORT}`));
export default app;
