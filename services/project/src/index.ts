...
app.get('/health', (_, res) => res.json({ service: 'brixstac-project-service', status: 'ok', ts: new Date().toISOString() }));
app.use('/', routes);
...
app.listen(PORT, () => console.log(`[brixstac-project-service] running on :${PORT}`));
export default app;
